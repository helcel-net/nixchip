...
let
  ...
  nixchipPackages = rec {
    ...
    cvc5 = branchOverride basePkgs.cvc5 "unstable-2026-09-22" (githubSource {
      owner = "cvc5";
      repo = "cvc5";
      rev = "ab20a7cc3d6ff62cc4721a8a57aa4502f6ef2328";
      hash = "sha256-an9RbR0GNpeTJngdzdpA8I4S/AAfwYeWXfqlHkUUxuw=";
    });
