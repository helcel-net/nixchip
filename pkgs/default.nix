...
let
  ...
  nixchipPackages = rec {
    ...
    openfpgaloader = branchOverride basePkgs.openfpgaloader "unstable-2026-08-18" (githubSource {
      owner = "trabucayre";
      repo = "openFPGALoader";
      rev = "63c519c3c57ded2d8cc412197d8b781115b1922a";
      hash = "sha256-pQni6VDUocnbz2OC+I151+QspAnuOIdy1WV5kqonZXU=";
    });
