...
let
  ...
  nixchipPackages = rec {
    ...
    cvc5_ = branchOverride basePkgs.cvc5 "unstable-2026-08-18" (githubSource {
      owner = "cvc5";
      repo = "cvc5";
      rev = "242ff48eb7c4302b544bf7657b9ff6be741e66dd";
      hash = "sha256-PFuTGkP3q7GRIQKQc2Hg4RnIbE/FLc6znmBxFwtHRdo=";
    });
