...
let
  ...
  nixchipPackages = rec {
    ...
    z3 =
      (branchOverride basePkgs.z3 "unstable-2026-09-22" (githubSource {
        owner = "Z3Prover";
        repo = "z3";
        rev = "cb83665b3039c165869a30da2955dd4655502e2a";
        hash = "sha256-c7B5bsy/qkSZhGM83qnkn9ww6n3Nx79wdlWfI0sqr1Q=";
      })).overrideAttrs
        (old: {
